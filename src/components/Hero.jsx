      ...
      <div className={`${styles.paddingX} absolute inset-0 top-[120px] max-w-7xl mx-auto flex flex-row items-start gap-5`}>
        ...
        <div>
          <h1 className={`${styles.heroHeadText} text-white mb-2`}>
            Hi , I&#39;m <span className='text-[#915eef]'>Nour Aldin</span>
            <p className={`${styles.heroSubText} text-white-100`}>
              I&#39;m a highly motivated and skilled Full Stack developer <br className='hidden sm:block' />
              with experience in building websites , great end‑user
              experience
            </p>
          </h1>
        </div>
